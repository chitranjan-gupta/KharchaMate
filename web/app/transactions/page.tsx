    ...
    reader.onload = (event) => {
      ...
      data.forEach((item: any) => {
        const a = {
          ...
          type: item["Amount"].startsWith("+")
            ? "deposit"
            : ("withdraw" as "deposit" | "withdraw"),
        ...
        if (a.type === "withdraw") {
          addExpense({
            ...
            note: `${a.note} Your Account: ${a.account}`,
          });
        }
        // if(a.type === "deposit") {
        //   addIncome({
        ...
        //     amount: Math.abs(a.amount),
        //     source: a.details,
        //     description: `${a.note} Your Account: ${a.account}`,
        //   });
        // }
        addTransaction(a);
      });
      ...
      <Card className="border-none shadow-sm">
        ...
        <CardContent className="space-y-3">
          <DataTable
            ...
            setCurrentTransaction={editTransaction}
          />
        </CardContent>
      </Card>
